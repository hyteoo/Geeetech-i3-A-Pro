 ...
 *
 * Custom settings for Geetech I3 A Pro
 * Modified by Teo Pavel: https://github.com/hyteoo/Geeetech-i3-A-Pro-Marlin-1.1.5
 * 
 * Updated for Marlin 1.1.5
 *
...
#define STRING_CONFIG_H_AUTHOR "(TeoPavel, Geeetech i3A Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "I3A Pro"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Geeetech i3 A Pro MK8 Extruder
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 50, 45 }
